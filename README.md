...
Security researchers: please review the [Threat Model & Limitations](#%EF%B8%8F-threat-model--limitations) section first. Responsible disclosure guidelines will be added in `SECURITY.md`.
