...
export class InitialSchema1769140849386 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."workflows_type_enum" AS ENUM('contract_deployment', 'trade_execution', 'ai_job_chain', 'indexing_verification', 'portfolio_update', 'reward_grant')`);
        await queryRunner.query(`CREATE TYPE "public"."workflows_state_enum" AS ENUM('pending', 'running', 'completed', 'failed', 'cancelled', 'compensating', 'compensated')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_e6b7312458454123287286afa6" ON "workflows" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_15206576633d3e612da44c882d" ON "workflows" ("type") `);
        await queryRunner.query(`CREATE INDEX "IDX_98afa5ee1ac04e690c908bbf85" ON "workflows" ("state") `);
        await queryRunner.query(`CREATE INDEX "IDX_619a202a61b92e73f20de8d29e" ON "workflows" ("idempotencyKey") `);
        await queryRunner.query(`CREATE TYPE "public"."workflow_steps_state_enum" AS ENUM('pending', 'running', 'completed', 'failed', 'skipped', 'compensating', 'compensated')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "workflow_steps" DROP CONSTRAINT "FK_eb0c057661503827a7cd6d8ea41"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ff0223ec6b4d2088d80a275370"`);
