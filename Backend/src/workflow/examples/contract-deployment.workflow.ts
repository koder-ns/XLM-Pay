  ...
  steps: [
    {
      ...
      execute: async (input: any, context: WorkflowContext) => {
        console.log(`Validating contract code for workflow: ${context.workflowId}`);
      ...
      compensate: async (input: any, output: any, context: WorkflowContext) => {
        console.log(`Compensating contract validation for workflow: ${context.workflowId}`);
    ...
    },
    {
      ...
      compensate: async (input: any, output: any, context: WorkflowContext) => {
        console.log(`Compensating contract deployment for workflow: ${context.workflowId}`);
    ...
    },
    {
      ...
      compensate: async (input: any, output: any, context: WorkflowContext) => {
        console.log(`Compensating contract verification for workflow: ${context.workflowId}`);
        
        if (output?.contractAddress) {
          // Remove verification from blockchain explorer
          console.log(`Removing verification for contract ${output.contractAddress}`);
        }
      },
    },
    {
      ...
      compensate: async (input: any, output: any, context: WorkflowContext) => {
        console.log(`Compensating contract indexing for workflow: ${context.workflowId}`);
